            ...
            <div class="m-2">
                ...
                <form action="/store" method="POST">
                    ...
                    <div class="my-2">
                        ...
                        <input class="w-full rounded py-3 px-3" type="text" name="custom_id" id="custom_id" placeholder="6 characters long">
                    </div>
                    <div class="flex justify-center my-6">
                        <button type="submit" class="transition ease-in-out bg-gradient-to-br from-[#1A1B26] to-[#464750] outline outline-offset-2 outline-1 outline-white text-white font-bold w-40 h-10 rounded hover:-translate-y-1 hover:scale-105 hover:shadow-xl">Create link</button>
                    </div>
                </form>
